...
public class MasterSheetUnicodeGenerator {
    ...
    public MasterSheetUnicodeGenerator(int srcCol, int tgtStartCol, String unicodeSuffix, String folder) {
        this.srcCol = srcCol;
...
//                        qasheet.getRow(i).createCell(4).setCellValue(tgtValue.replaceAll("\\.", ","));
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
       ...
       /**
        * 1. Put your label sheet in a separate folder.
        * 2. Under "srcCol", put the starting column number of the source (English content). Note: If the source column is 1, put 0; if it is 2, put 1.......
        * 3. Under "unicodeSuffix", put the column name or anything you think fits a descriptor purpose .
        * 4. Under "folder" ,put the folder path containing your label sheet.
        * */

        MasterSheetUnicodeGenerator d1 = new MasterSheetUnicodeGenerator(1, 2, "Description1", "C:\\Users\\trunk\\OneDrive\\桌面\\workaholic\\2006124\\qa");
